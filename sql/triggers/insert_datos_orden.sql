...
BEGIN
    ...
    VALUES(new.fecha_registro, new.fecha_visita, new.idtecnico, new.direccion_servicio, new.movil, new.movil, '', new.email, new.identificacion, new.estado, new.nombre_completo, new.notas, new.fecha_instalacion, new.idzona, null, 0, new.idplan, new.nit, new.notas);
END;
